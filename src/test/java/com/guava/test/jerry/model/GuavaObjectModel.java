...
public class GuavaObjectModel {
     ...
     */
    public GuavaObjectModel(
            final String newLastName, final String newFirstName,
            final String newEmployerName, final GuavaObjectModel.Gender newGender)
    {
    ...
    public GuavaObjectModel.Gender getGender()
    {
        return this.gender;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final GuavaObjectModel other = (GuavaObjectModel) obj;
